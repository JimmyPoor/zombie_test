...
class Parent:
	...
	def __init__(self):
		self.dh = "123213"
		self.zjlx = Enums_SFZJLX.居民身份证.value
		self.sfjhr = "1"
		self.cyzj = None
		self.updateuserid = None
		self.zjhm = "123123"
		self.hjdzjdz = None  # null,
		self.deletedtime = None  # null,
		self.deleteduserid = None  # null,
		self.jzzyxq = None  # null,
		self.jzzlx = None  # null,居住证类型 Enums_JZZLX
		self.jzzhm = None  # null,
		self.jzzjfsfdb = None
		self.id = "1"
		self.hjxxdz = None  # null,
		self.sfbzf = None  # null,
		self.hksf = Enums_SHANGHAI.上海市.value  # null,
		self.hks = Enums_SHANGHAI.上海市.value  # null,
		self.qx = Enums_SHANGHAI.徐汇区.value  # null,
		self.xb = Enums_XB.男.value
		self.studentid = "1"
		self.gx = "1"
		self.deleted = "0"
		self.xl = None  # null,学历
		self.xm = "xiaohuihui"
		self.gzdw = None  # null,工作单位
		self.addtime = "1"
		self.impno = None  # null,
		self.adduserid = "1"
		self.updatetime = "2020-02-11 14:10:40"  # null,
		self.jydjcs = None  # null,
		self.hjdzjwhc = None  # null
